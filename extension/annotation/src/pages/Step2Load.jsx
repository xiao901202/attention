...
export default function Step2Load({
  ...
  const question = reframed ? survey?.step2_reframe : survey?.step2_question;
  const options = survey?.step2_options;
  ...
  const handleNext = useCallback(() => {
    ...
    console.log('[Step2] submit:', { selected, confidence, confObj: conf });
  ...
  return (
    ...
    >
      <ProgressBar current={2} total={totalSteps} label={`標註進度 2/${totalSteps}`} />

      {/* Step 2: collapsed video pill, click to expand */}
      {videoExpanded ? (
        <div>
